...
const App = () => {
  ...
  const featuredStudios = [
    { 
      ...
      startupCount: 30, 
      exitCount: 4,
      description: "「人と人をつなげる」をミッションに、シェアリングエコノミーやDAO、Web3領域で起業家を支援。若手起業家の輩出に強み。",
      founded: "2015年",
      fullDescription: "ガイアックスは「人と人をつなげる」をミッションに、シェアリングエコノミーやDAO、Web3領域で次世代の社会構造を作る起業家を支援しています。起業家の発掘から事業開発、資金調達まで一気通貫でサポート。ファウンダーの8割が学生〜新卒3年目の若手起業家を輩出しており、アディッシュ、Photosynthなど4社が上場を達成しています。",
    ...
    { 
      ...
      startupCount: 13, 
      exitCount: 0,
      description: "南場智子氏が創設。投資事業とベンチャービルダー事業を両輪で展開し、本業継続しながら起業準備が可能。",
      founded: "2019年",
      fullDescription: "デライト・ベンチャーズは、DeNA創業者の南場智子氏が設立した独立系VC。投資事業とベンチャービルダー事業を両輪で展開し、本業を継続しながら起業準備ができる環境を提供。約90社への投資実績があり、ベンチャービルダー事業からは13社以上が独立しています。",
    ...
    { 
      ...
      startupCount: 3, 
      exitCount: 0,
      description: "エンタメ業界のイノベーションを加速するバーティカル型スタートアップスタジオ。MIXIと連携。",
      founded: "2020年",
      fullDescription: "Studio ENTREは、エンターテインメント業界（音楽、映像、出版、ファッション）に特化したバーティカル型スタートアップスタジオです。MIXIエンターテインメントファンドと連携し、FAVER、.mura、muvicaなどのスタートアップを創出しています。",
    ...
    { 
      ...
      startupCount: 0, 
      exitCount: 0,
      description: "東京工業大学関連VCからカーブアウト。高専生エンジニアコミュニティを強みに起業前段階から伴走支援。",
      founded: "2022年",
      fullDescription: "みらいスタジオは、みらい創造機構からカーブアウトしたスタートアップスタジオです。高専生・卒業生によるエンジニアコミュニティを強みに、ディープテックや研究開発型スタートアップの起業前段階から伴走支援を行っています。親会社ではIPO4社、M&A4社の実績があります。",
      website: "https://miraistudio.co.jp/",
      logoUrl: "/logos/mirai.png"
    },
    { 
      id: 5, 
      name: "QUANTUM", 
      ...
      founded: "2016年",
      fullDescription: "QUANTUMは博報堂の100%子会社として、クリエイティビティと実装力を武器に新規事業を連続創出するスタートアップスタジオです。ヘルスケア、モビリティ、D2Cなど全領域で100社超との事業開発実績があり、アジア初のGSSN（Global Startup Studio Network）加盟スタジオとなりました。",
    ...
    { 
      ...
      location: "東京都渋谷区", 
      type: "独立系",
      category: "クリエイティブ・マーケティング", 
      startupCount: 4, 
      exitCount: 0,
      description: "クリエイティブ集団PARTYを母体とし、マーケティング・クリエイティブ力を武器にスタートアップを支援。",
      founded: "2020年",
      fullDescription: "comboは、クリエイティブ集団PARTYを母体とし、凸版印刷等の出資を受けて設立されたスタートアップスタジオです。マーケティング、ブランディング、UI/UXなどクリエイティブ領域の強みを活かし、スタートアップと企業の新規事業を支援しています。",
      website: "https://combo.jp/",
      logoUrl: "/logos/combo.png"
    },
    { 
      id: 7, 
      ...
      startupCount: 4, 
      exitCount: 0,
      description: "5,000社以上の新規事業支援実績を持つRelicが運営。検証費用最大1,000万円を提供する全方位型スタジオ。",
      founded: "2023年",
      fullDescription: "ZERO1000 Venturesは、Relicホールディングスが運営するスタートアップスタジオです。5,000社以上の新規事業支援実績を活かし、検証費用最大1,000万円を提供。RUFU、MEAL FORWARD、3rd Economy、Pro3 Labなどを創出。雇用保障付き事業検証や学生向けプログラムも展開しています。",
      website: "https://relic.co.jp/services/zero1000_ventures/",
      logoUrl: "/logos/zero1000.png"
    },
    { 
      id: 8, 
      name: "ボーダレス・ジャパン", 
      ...
      startupCount: 50, 
      exitCount: 0,
      description: "「SWITCH to HOPE」をパーパスに、ソーシャルビジネスのみを創出。独自の「恩送り資金」システムで社会起業家を連続輩出。",
      founded: "2007年",
    ...
    { 
      ...
      startupCount: 20, 
      exitCount: 0,
      description: "NECの125年の技術力と45,000件以上の特許を活用し、シリコンバレーでスタートアップを創出・育成。",
      founded: "2018年",
    ...
    { 
      ...
      startupCount: 54, 
      exitCount: 0,
      description: "三井物産グループ45,000人からアイデアを公募し、0→1のビジネス創造と人材育成を推進。",
      founded: "2018年",
    ...
    { 
      ...
      startupCount: 0, 
      exitCount: 0,
      description: "東大卒業生・研究者向けに最初の1億円調達まで無償（Non-equity）で支援するインセプションプログラム。",
      founded: "2019年",
      fullDescription: "FoundXは、東京大学 産学協創推進本部が運営するスタートアップインセプションプログラムです。東大卒業生・研究者向けに、最初の1億円調達まで無償（Non-equity）で支援。気候変動、労働力不足、産業再構築などハイグロース全般の領域で、東大関連577社のスタートアップ創出に貢献しています。",
      website: "https://foundx.jp/",
      logoUrl: "/logos/foundx.png"
    },
    { 
      id: 12, 
      name: "スタートアップファクトリー", 
      ...
      startupCount: 20, 
      exitCount: 0,
      description: "元放送作家の鈴木おさむ氏が設立した約23億円規模のtoC向けベンチャーファンド。",
      founded: "2024年",
      fullDescription: "スタートアップファクトリーは、元放送作家の鈴木おさむ氏が設立した約23億円規模のtoC向けベンチャーファンドです。エンタメ・コンテンツ領域に特化し、ビジネスコンテスト「C×E×O」を開催。約20社以上への投資実績があります。",
      website: "https://startupfactory.co.jp/",
      logoUrl: "/logos/startupfactory.png"
    },
    { 
      id: 13, 
      name: "Algomatic", 
      ...
      startupCount: 0, 
      exitCount: 0,
      description: "「AI革命で人々を幸せにする」をミッションに、カンパニー制で同時多発的に事業を立ち上げる生成AI特化型スタジオ。",
      founded: "2023年",
    ...
    { 
      ...
      location: "東京都港区", 
      type: "VC系",
      category: "グローバル・ディープテック", 
      startupCount: 0, 
      exitCount: 0,
      description: "創業期からのリスクマネー提供でユニコーン創出を目指すVC。EIRと共同創業にも取り組む。",
      founded: "2023年",
      fullDescription: "ON&BOARDは、グローバル展開志向のディープテック・大学発ベンチャーに特化したVCです。2024年にファンドを設立し、創業期からのリスクマネー提供でユニコーン創出を目指しています。EIR（Entrepreneur in Residence）との共同創業にも積極的に取り組んでいます。",
      website: "https://onboardvc.com/",
      logoUrl: "/logos/onboard.png"
    },
    { 
      id: 15, 
      name: "DNX Studio", 
      ...
      startupCount: 0, 
      exitCount: 0,
      description: "DNX VenturesのB2B SaaS特化スタジオ。米国High Alpha Innovationと協働し、3〜6ヶ月の短期集中型創業プログラム。",
      founded: "2024年",
      fullDescription: "DNX Studioは、B2B SaaS投資で実績のあるDNX Venturesが立ち上げたスタートアップスタジオです。米国High Alpha Innovationと協働し、3〜6ヶ月の短期集中型創業プログラムを提供。パイロットプログラムを経て本格稼働しています。",
      website: "https://www.dnx.vc/jp",
      logoUrl: "/logos/dnx.png"
    },
    { 
      id: 16, 
      name: "POLAR SHORTCUT", 
      ...
      startupCount: 8, 
      exitCount: 0,
      description: "北海道特化のシードVC兼スタートアップスタジオ。共同創業型投資モデルで事業企画から立ち上げまで伴走支援。",
      founded: "2020年",
    ...
    { 
      ...
      startupCount: 12, 
      exitCount: 2,
      description: "新規事業成功経験者が集結し、既存産業×テクノロジーで多発的にスタートアップを創出するスタジオ。",
      founded: "2018年",
      fullDescription: "XTechは、新規事業成功経験者が集結したスタートアップスタジオです。既存産業×テクノロジー（AI、IoT、ブロックチェーン、5G）で多発的にスタートアップを創出。イークラウド、クロスマート、Radiotalkなど12社以上を輩出し、投資先ではスペースマーケット、ベースフードなど複数社がIPOを達成しています。",
    ...
    { 
      ...
      startupCount: 4, 
      exitCount: 2,
      description: "「起業を標準化させる」をミッションにDX・バーティカルSaaS特化。2022年に17.8億円調達。",
      founded: "2021年",
    ...
    { 
      ...
      startupCount: 200, 
      exitCount: 0,
      description: "孫泰蔵氏が設立したコレクティブ・インパクト・コミュニティ。複数の起業家の社会的インパクトを結集させる支援を展開。",
      founded: "2013年",
          ...
          <section className="relative z-10 -mt-6 sm:-mt-10 px-4 sm:px-6">
            <div className="max-w-7xl mx-auto bg-white/[0.03] backdrop-blur-3xl border border-white/10 rounded-[1.5rem] sm:rounded-[2.5rem] p-6 sm:p-10 md:p-16">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-12">
                {[
                  { label: "Studios", value: "19", unit: "社", icon: Building2, color: "text-blue-400" },
                  { label: "Ventures", value: "500+", unit: "社", icon: Rocket, color: "text-purple-400" },
                  { label: "Funding", value: "450+", unit: "億円", icon: DollarSign, color: "text-yellow-400" },
                  { label: "Exits", value: "10+", unit: "件", icon: Trophy, color: "text-red-400" },
                ].map((stat, idx) => (
